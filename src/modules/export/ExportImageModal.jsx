...
import { exportControllerToImage } from './image.jsx'
import { AVAILABLE_CONTROLLERS } from '../controllers/registry.js'
      ...
      <div className="modal-content export-image-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="context-checkboxes">
              {AVAILABLE_CONTROLLERS.map(controller => (
                <label key={controller.id} className="context-checkbox-item">
                  ...
                  />
                  <Icon name={controller.icon} className="controller-icon" />
        ...
        <div className="modal-footer">
          ...
          >
            {isExporting ? (
              <>
                <Icon name="spinner" spin /> Exporting...
              </>
            ) : (
              <>
                <Icon name="download" /> Export Images
              </>
            )}
          </button>
        </div>
