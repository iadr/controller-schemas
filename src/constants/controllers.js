...
import { JOYCON_BUTTONS } from './joycon'
...
export const AVAILABLE_CONTROLLERS = [
  ...
  { id: 'joycon', name: 'Nintendo Switch Joy-Con (L)', icon: 'bi bi-nintendo-switch', type: 'controller', category: 'Controllers' },
  { 
    id: 'steamdeck', 
    name: 'Steam Deck', 
    icon: 'bi bi-steam', 
...
export const getControllerConfig = (controllerId) => {
  switch (controllerId) {
    ...
    case 'joycon':
      return { name: 'Nintendo Switch Joy-Con (L)', image: joyConImage, buttons: JOYCON_BUTTONS }
    case 'switch':
      return {
